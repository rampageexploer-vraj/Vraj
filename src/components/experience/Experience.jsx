    ...
    return (
        <div ref={sectionRef} id='experience' className='w-full bg-black px-6 md:px-12 py-20 md:py-32'>
            ...
            <div className='flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-24 gap-6 md:gap-0'>
                <div>
                    <p className='text-accent text-2xs md:text-xs uppercase tracking-widest font-font2 mb-3 md:mb-4'>Experience</p>
                    <h2 className='text-white text-4xl md:text-6xl lg:text-display-sm font-font2 uppercase tracking-tighter leading-none mb-4 md:mb-6'>Where I&apos;ve Worked</h2>
            ...
            <div ref={listRef} className='relative'>
                ...
                <div ref={lineFillRef} className='absolute left-0 top-0 w-px h-full bg-accent' />
                ...
                {experience.map((job) => (
                    <div key={job.role} className='exp-row relative pl-10 md:pl-14 pb-14 md:pb-16 last:pb-0'>
                        ...
                        <p className={`text-2xs md:text-xs font-font2 tracking-widest uppercase mb-2 md:mb-3 ${job.current ? 'text-accent' : 'text-gray-500'}`}>
                            {job.period}
                        </p>
